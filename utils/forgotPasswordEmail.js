const ForgotPasswordEmail = (otp, currentYear, userName) => {
  return `
  <!DOCTYPE html>
  <html lang="en">
  <head>
  ...
  <body>
      <div class="container">
          ...
          <div class="content">
              ...
              <p>If you did not request this, please ignore the email or contact our support.</p>
              <p>Thank you,<br>The Bizbridge Team</p>
          </div>
          <div class="footer">
